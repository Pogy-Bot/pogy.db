...
class DatabaseManager {
    ...
    static isCacheEnabled(options) {
        var _a, _b, _c;
        return (options && ((_a = options.cache) === null || _a === void 0 ? void 0 : _a.toggle) === true ? true : false) ? true : ((_b = this.options.cache) === null || _b === void 0 ? void 0 : _b.toggle) === true && (options ? ((_c = options === null || options === void 0 ? void 0 : options.cache) === null || _c === void 0 ? void 0 : _c.toggle) !== false : true) ? true : false;
    }
}
/**
 * The library events
