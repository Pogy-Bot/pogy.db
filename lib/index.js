...
module.exports = {
    ...
    ping: function (options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!database_1.default.tables.includes(options.tableName)) return false;
            const functions = [
                () =>
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        try {
                            ...
                            step = 6;
                            const newTable = yield newConnectionDatabase.model(
                                schema,
    ...
    table: function (tableName, tableOptions) {
        return (() =>
            __awaiter(this, void 0, void 0, function* () {
                if (!database_1.default.client) return false;
                ...
                this.get = function (key, options) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            if (
                                (((_a = options === null || options === void 0 ? void 0 : options.cache) === null || _a === void 0 ? void 0 : _a.cacheOnly) ||
                                    ((_c = (_b = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _b === void 0 ? void 0 : _b.cache) === null || _c === void 0 ? void 0 : _c.cacheOnly)) &&
                                !(
                                    ((_d = options === null || options === void 0 ? void 0 : options.cache) === null || _d === void 0 ? void 0 : _d.toggle) ||
                                    ((_f = (_e = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _e === void 0 ? void 0 : _e.cache) === null || _f === void 0 ? void 0 : _f.toggle)
                                )
                            ) {
                            ...
                            if (isCacheEnabled && !database_1.default.cache) database_1.default.enableCache();
                            if (isCacheEnabled) {
                            ...
                            if (
                                !fetchedData &&
                                (((_g = options === null || options === void 0 ? void 0 : options.cache) === null || _g === void 0 ? void 0 : _g.cacheOnly) ||
                                    ((_j = (_h = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _h === void 0 ? void 0 : _h.cache) === null || _j === void 0 ? void 0 : _j.cacheOnly))
                            )
                                return null;
                            if (!fetchedData) {
                                let targetProvided;
                ...
                this.set = function (key, value, options) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            if (targetProvided) {
                                if (isCacheEnabled) {
                                    if (database_1.default.redis) {
                                        ...
                                        if (redisTTL !== -1) yield database_1.default.redis.expire(this.table.collection.name + "." + key + "." + targetProvided, redisTTL);
                                    } else {
                                ...
                                if (
                                    !(
                                        ((_j = options === null || options === void 0 ? void 0 : options.cache) === null || _j === void 0 ? void 0 : _j.cacheOnly) ||
                                        ((_l = (_k = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _k === void 0 ? void 0 : _k.cache) === null || _l === void 0 ? void 0 : _l.cacheOnly)
                                    )
                                ) {
                                    yield this.table.updateOne(
                                        { id: key },
                                        {
                                ...
                                if (isCacheEnabled && tableOptions && tableOptions.cacheLargeData) {
                                    if (database_1.default.redis) {
                                        ...
                                        if (redisTTL !== -1) yield database_1.default.redis.expire(this.table.collection.name + "." + key + "." + targetProvided, redisTTL);
                                    } else database_1.default.cache.set(this.table.collection.name + "." + key, value);
                                }
                                if (
                                    !(
                                        ((_q = options === null || options === void 0 ? void 0 : options.cache) === null || _q === void 0 ? void 0 : _q.cacheOnly) ||
                                        ((_s = (_r = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _r === void 0 ? void 0 : _r.cache) === null || _s === void 0 ? void 0 : _s.cacheOnly)
                                    )
                                ) {
                                    yield this.table.updateOne(
                                        { id: key },
                            ...
                            if ((_u = options === null || options === void 0 ? void 0 : options.database) === null || _u === void 0 ? void 0 : _u.ttl) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            if (targetProvided) {
                                if (isCacheEnabled) {
                                    if (database_1.default.redis) {
                                        ...
                                        if (database_1.default.cache.get(this.table.collection.name + "." + key + "." + targetProvided)) {
                                            ...
                                            if (
                                                !(
                                                    ((_k = options === null || options === void 0 ? void 0 : options.cache) === null || _k === void 0 ? void 0 : _k.cacheOnly) ||
                                                    ((_m = (_l = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _l === void 0 ? void 0 : _l.cache) === null || _m === void 0 ? void 0 : _m.cacheOnly)
                                                )
                                            ) {
                                                yield this.table.updateOne(
                                                    { id: key },
                                            ...
                                            const dataFetched = yield this.table.findOneAndUpdate(
                                                { id: key },
                                                {
                                                    $inc: {
                                                        [targetProvided ? "data." + targetProvided : "data"]: value
                                    ...
                                    if (
                                        !(
                                            ((_o = options === null || options === void 0 ? void 0 : options.cache) === null || _o === void 0 ? void 0 : _o.cacheOnly) ||
                                            ((_q = (_p = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _p === void 0 ? void 0 : _p.cache) === null || _q === void 0 ? void 0 : _q.cacheOnly)
                                        )
                                    ) {
                                        yield this.table.updateOne(
                                            { id: key },
                                ...
                                if (
                                    !(
                                        ((_r = options === null || options === void 0 ? void 0 : options.cache) === null || _r === void 0 ? void 0 : _r.cacheOnly) ||
                                        ((_t = (_s = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _s === void 0 ? void 0 : _s.cache) === null || _t === void 0 ? void 0 : _t.cacheOnly)
                                    )
                                ) {
                                    yield this.table.updateOne(
                                        { id: key },
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            if (targetProvided) {
                                ...
                                if (
                                    !(
                                        ((_u = options === null || options === void 0 ? void 0 : options.cache) === null || _u === void 0 ? void 0 : _u.cacheOnly) ||
                                        ((_w = (_v = database_1.default === null || database_1.default === void 0 ? void 0 : database_1.default.options) === null || _v === void 0 ? void 0 : _v.cache) === null || _w === void 0 ? void 0 : _w.cacheOnly)
                                    )
                                ) {
                                    yield this.table.updateOne(
                                        { id: key },
                        ...
                        try {
                            ...
                            if (
                                ...
                                if (database_1.default.redis) {
                                    ...
                                    if (database_1.default.cache.has(this.table.collection.name + "." + key + "." + targetProvided)) return true;
                                    else return false;
                                }
                            } else {
                            ...
                            yield this.table
                                ...
                                .then(() =>
                                    __awaiter(this, void 0, void 0, function* () {
                                        ...
                                        if (targetProvided) {
                                            fetchedData = lodash_1.default.get(fetchedData, targetProvided);
                                            if (options && options.cache && !database_1.default.cache) database_1.default.enableCache();
                                            if (isCacheEnabled) {
                                                if (!database_1.default.redis) {
                                                    database_1.default.cache.set(this.table.collection.name + "." + key + "." + targetProvided, fetchedData);
                                                } else {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            if (
                                ...
                                let filtered = AllStoredData.filter((v) => {
                                    var _a, _b;
                                    return (_b = (_a = options === null || options === void 0 ? void 0 : options.filter) === null || _a === void 0 ? void 0 : _a.call(options, { id: v.id, data: v.data })) !== null && _b !== void 0 ? _b : true;
                                }).map((m) => ({
                                    id: m.id,
                                    data: m.data
                                }));
                                ...
                                if (database_1.default.redis === undefined || database_1.default.cache === undefined) return null;
                                if (!database_1.default.redis) {
